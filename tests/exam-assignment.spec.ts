...
const COURSE = {
  id: "c-ex", name: "Exams 101", description: "", status: "active", source: "manual",
  coverColor: "#0F766E", iconColor: "#0F766E", courseTemplateId: "ct-ex", term: 1, academicYear: 2569,
...
test.describe("Exam — teacher form", () => {
  test.beforeEach(async ({ page }) => {
    await page.addInitScript(() => {
      ...
      localStorage.setItem("hwai_courses_v2", JSON.stringify([{ id: "c-exf", name: "Web", description: "", status: "active", source: "manual", coverColor: "#0F766E", iconColor: "#0F766E", createdAt: now, updatedAt: now }]));
