      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0 mt-0.5">
            <span className="text-xs text-gray-400 whitespace-nowrap">{formatNotifTime(notif.createdAt)}</span>
...
function GroupLabel({ label }: { label: string }) {
  return (
    <p className="text-xs font-semibold text-gray-400 tracking-widest uppercase mb-3 mt-6 first:mt-0">
      {label}
    </p>
  );
}
