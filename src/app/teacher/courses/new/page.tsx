  ...
  return (
      <main className="w-full px-8 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6 flex-wrap">
          ...
          <span>/</span>
          <span className="text-[var(--accent)] font-medium">{t("เพิ่มรายวิชาใหม่", "Add New Course")}</span>
        </div>

        <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-6">{t("เพิ่มรายวิชาใหม่", "Add New Course")}</h1>
