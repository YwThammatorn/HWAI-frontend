      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4">
        <ul role="list" className="flex flex-col gap-0.5">
            ...
            <Link
              ...
              className={[
                ...
                isActive("/student", true)
                  ? "bg-[#F97316]/15 text-[#C2410C] border-l-2 border-[#F97316]"
                  : "text-[var(--text-secondary)] hover:bg-[var(--bg-subtle)] hover:text-[var(--text-primary)]",
              ].join(" ")}
            >
              <span className={isActive("/student", true) ? "text-[#C2410C]" : "text-[var(--text-muted)]"} aria-hidden="true">
            ...
            <button
              ...
              className={[
                ...
                pathname.startsWith("/student/courses")
                  ? "text-[#C2410C] bg-[#F97316]/10"
                  : "text-[var(--text-secondary)] hover:bg-[var(--bg-subtle)] hover:text-[var(--text-primary)]",
              ].join(" ")}
            >
              <span className={pathname.startsWith("/student/courses") ? "text-[#C2410C]" : "text-[var(--text-muted)]"} aria-hidden="true">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                        ...
                        <li key={sub.key}>
                          <Link
                            ...
                            className={[
                              ...
                              "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F97316]",
                              active
                                ? "text-[#C2410C] bg-[#F97316]/10 border-l-2 border-[#F97316] ml-1"
                                : "text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-subtle)]",
                            ].join(" ")}
                          >
          ...
          <li>
            ...
            >
              <span className={isActive("/student/calendar") ? "text-[#C2410C]" : "text-[var(--text-muted)]"} aria-hidden="true">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
